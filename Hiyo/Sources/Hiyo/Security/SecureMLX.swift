...
enum SecureMLX {
    ...
    static func configureSafeLimits() {
        ...
        let totalMemory = Int(ProcessInfo.processInfo.physicalMemory) // (8 * 1024 * 1024 * 1024) // Assume 8 GB if unknown
    ...
    static func verifyMLXConfiguration() -> Bool {
        ...
        let totalMemory = Int(ProcessInfo.processInfo.physicalMemory) // (16 * 1024 * 1024 * 1024) // Assume 16 GB if unknown
