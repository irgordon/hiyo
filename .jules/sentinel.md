...
## 2026-09-03 - Unchecked Random Number Generation
**Vulnerability:** The result of SecRandomCopyBytes was discarded, potentially leading to silently generated zeroed encryption keys if random number generation fails.
**Learning:** System cryptographic APIs often return OSStatus instead of throwing errors. Discarding this return value masks critical failures.
**Prevention:** Always explicitly verify that the returned OSStatus from cryptographic functions is errSecSuccess and handle failures appropriately.
